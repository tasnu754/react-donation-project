...
const DonateCartAdd = ({donateCards}) => {
  ...
  return (
    <div className="">
      <div
        className={`w-full card card-side bg-[${donateCards.card_bg_color}] shadow-xl`}
        style={{ background: donateCards.card_bg_color }}
      >
        <figure>
          <img
        ...
        <div className="card-body">
          <button
            ...
            style={{
              color: donateCards.text_button_bg_color,
              background: donateCards.category_bg_color,
            }}
          >
          ...
          <p
            ...
            style={{ color: donateCards.text_button_bg_color }}
          >
            ${donateCards.price}
          </p>
          <div className="card-actions justify-start ">
            <button
              ...
              style={{ background: donateCards.text_button_bg_color }}
            >
              View Details
            </button>
          </div>
